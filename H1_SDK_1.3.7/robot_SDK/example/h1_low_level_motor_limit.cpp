...
const float motor_limit_max[23] = {0, 0, 0.8, 1.3,  0.7,   1.5,  0.25,  1.5,  2.0,  2.9,  1.5,  2.9,  1.0,  1.0,  1.5,  1.5,  0.3,  2.9,  1.5,  2.9,  1.0,  1.0, 1.5};
const float motor_limit_min[23] = {0, 0, 0,   0,   -0.7,  -1.5, -0.17, -2.7, -0.3, -2.9, -1.3, -2.9, -1.0, -1.0,  0,   -2.7, -2.0, -2.9, -1.3, -2.9, -1.0, -1.0, 0  };
...
int main() {
    ...
    //实例化机器人
    // H1Robot robot("192.168.2.165");//SDK运行环境为用户主机，无线连接方式，ip不固定
