...
public:
    ...
    //     // 控制坐标系：0=相对初始位置坐标系，2=相对原点坐标系
    //     int32_t control_coordinate;
    ...
    // }
    //具体参数含义如上述
    // 设置高级控制指令,提供笛卡尔空间（位置+姿态）的运动控制功能。
    bool setHighLevelControl(const HighLevelControl& control);
